  ...
  Future<void> getDetails() async {
    try {
      ...
      DetailEvent event = DetailEvent(
          ...
          jsonData['field_termin']['und'][0]['value'],
          jsonData['field_lokalizacja']['und'][0]['thoroughfare'],
          jsonData['field_lokalizacja']['und'][0]['postal_code'],
          jsonData['field_lokalizacja_dodatkowe_info'].length <= 1 ?
            Strings.NO_DATA : jsonData['field_lokalizacja_dodatkowe_info']['und'][0]['value'] );
      return event;
    } on Exception {}
  }
}
